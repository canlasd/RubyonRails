...
def comment
	Review.find(params[:id]).comments.create(comment_params)
...
def review_params
      params.require(:review).permit(:poster, :date, :article, :title)
end

def comment_params
      params.require( :comment).permit(:poster, :date, :comment)
